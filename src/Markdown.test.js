...
test("Markdown parser should parse headings", () => {
...
test("Markdown parser should parse paragraphs", () => {
	const md = new Markdown()
...
test("Markdown parser should parse ordered list", () => {
	const md = new Markdown()
...
test("Markdown parser should parse unordered list", () => {
	const md = new Markdown()
...
test("Markdown parser should parse code block", () => {
	const md = new Markdown()
...
test("Markdown parser should parse blockquote", () => {
	const md = new Markdown()
...
test("Markdown parser should parse horizontal rule", () => {
	const md = new Markdown()
...
test("Markdown parser should stringify to html", () => {
	const md = new Markdown()
	md.parse("# Title\n\nParagraph\n\n1. first\n2. second\n\n```js\ncode\n```")
...
test("Markdown parser should allow interceptor in stringify", () => {
	const md = new Markdown()
	md.parse("# Title")
	const html = md.stringify(el => {
		if (el instanceof MDHeading1) {
			return `<h1 class="custom">${el.content}</h1>`
		}
		return null
	})
